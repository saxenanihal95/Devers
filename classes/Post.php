...
class Post
{
	...
	public static function link_add($text)
	{
		...
		foreach ($text as $word) {
			if(substr($word,0,1)=="@")
			{
				$newstring.="<a href='profile.php?username=".substr($word,1)."' style='text-decoration:none;'>".htmlspecialchars($word)." </a>";
			}else if(substr($word,0,1)=="#")
			{
				$newstring.="<a href='topics.php?topic=".substr($word,1)."' style='text-decoration:none;'>".htmlspecialchars($word)." </a>";
			}
			else{
